...
import static com.example.restaurantlist.R.layout.row;
...
public class RestaurantList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main); // Make sure to use the correct layout file.
    ...
    class RestaurantAdapter extends ArrayAdapter<Restaurant> {
        RestaurantAdapter() {
            super(RestaurantList.this, row, model);}
        @Override
